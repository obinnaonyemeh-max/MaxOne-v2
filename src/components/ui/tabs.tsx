...
const tabsListVariants = cva(
  "group/tabs-list inline-flex w-fit items-center justify-center rounded-lg p-[3px] text-muted-foreground group-data-[orientation=horizontal]/tabs:h-9 group-data-[orientation=vertical]/tabs:h-fit group-data-[orientation=vertical]/tabs:flex-col data-[variant=line]:rounded-none data-[variant=line]:h-auto data-[variant=line]:overflow-x-auto data-[variant=line]:overflow-y-hidden data-[variant=line]:overscroll-none data-[variant=line]:scrollbar-hide",
  {
    variants: {
      variant: {
        default: "bg-muted",
        line: "gap-1 bg-transparent border-b border-transparent",
      },
    },
    defaultVariants: {
      variant: "default",
