      ...
      <div className="flex flex-1 flex-col overflow-hidden px-6 pb-6">
        ...
        {viewMode === "grid" ? (
          ...
          <div className="flex min-h-0 flex-1 gap-4 overflow-hidden">
            <div className="flex w-[390px] shrink-0 flex-col overflow-hidden rounded-lg border border-gray-200 bg-white">
            ...
            <div className="relative z-0 min-h-0 flex-1 isolate overflow-hidden rounded-lg border border-gray-200 bg-white p-2">
              <StationsMap
