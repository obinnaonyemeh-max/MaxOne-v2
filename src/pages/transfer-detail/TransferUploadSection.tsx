...
export function TransferUploadSection({ uploadedFile, onFileSelect, showCard = true }: Props) {
  ...
  const content = (
    <>
      {uploadState === "idle" && (
        <DocDropZone file={null} onFileSelect={handleFileSelect} />
      )}

      {uploadState === "uploading" && (
        <div className="flex flex-col justify-center gap-3 rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 px-6 py-5 min-h-[100px]">
      ...
      {uploadState === "uploaded" && (
        <div className="flex flex-col items-center justify-center gap-2 rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 py-4 min-h-[100px]">
